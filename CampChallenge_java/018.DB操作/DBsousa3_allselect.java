...
大単元「データベース基礎」の課題「テーブルの作成とinsert」で作成したテーブルについて，レコードを全件検索してください。また，検索結果のレコードについて，すべてのカラムの値を画面に表示してください。
 */
package DBsousa;
 ...
 * @author hatano
 */
@WebServlet(name = "DBsousa3_allselect", urlPatterns = {"/DBsousa3_allselect"})
public class DBsousa3_allselect extends HttpServlet {
